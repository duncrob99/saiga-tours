(function() {
  let firstname_input = document.querySelector('#id_first_name');
  let lastname_input = document.querySelector('#id_last_name');
  let email_input = document.querySelector('#id_email');
  let password_input = document.querySelector('#id_password1') ?? document.querySelector('#id_password');
  let password_confirm_input = document.querySelector('#id_password2');
  ...
  function validate_password() {
    ...
    let password_strength = zxcvbn(password_input.value, [email_input.value, firstname_input.value, lastname_input.value]);
  ...
  function validate_signup() {
    ...
    if (validate_password() >= 75 && password_input.value == password_confirm_input.value && email_input.value.length > 0) {
  ...
  email_input.addEventListener('input', validate_signup);
