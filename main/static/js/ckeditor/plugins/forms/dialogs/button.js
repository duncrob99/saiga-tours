...
CKEDITOR.dialog.add("button", function (b) {
    ...
    return {
        title: b.lang.forms.button.title, minWidth: 350, minHeight: 150, getModel: function (a) {
            ...
            var a = this.getParentEditor(), b = this.getModel(a), d = this.getMode(a) == CKEDITOR.dialog.CREATION_MODE,
            ...
            elements: [{
                ...
                "default": "button",
                accessKey: "T",
                items: [[b.lang.forms.button.typeBtn, "button"], [b.lang.forms.button.typeSbm,
                    "submit"], [b.lang.forms.button.typeRst, "reset"]],
                setup: function (a) {
